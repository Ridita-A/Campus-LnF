...
DROP PROCEDURE IF EXISTS create_lost_report(INT, INT, VARCHAR, TEXT, TIMESTAMP, TEXT[]);
DROP PROCEDURE IF EXISTS create_found_report(INT, INT, VARCHAR, TEXT, TIMESTAMP, TEXT[]);
